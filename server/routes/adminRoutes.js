...
// bidding routes
router.post('/bidding/create', authMid, adminMid, createBidding);
router.get('/bidding/get/:id', authMid, getBiddingDetails);
router.post('/bidding/update/:id', authMid, updateBillingWinner);
